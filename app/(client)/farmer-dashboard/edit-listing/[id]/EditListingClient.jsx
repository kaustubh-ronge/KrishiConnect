...
import { ArrowLeft, Edit, Save, Scale, IndianRupee, Calendar, Tag, X, Image as ImageIcon, Phone, Truck } from "lucide-react";
            ...
            <CardHeader className="bg-green-50/50 border-b border-green-100 pb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Update product details, price, or stock.</p>
                </div>
              </div>
            </CardHeader>
