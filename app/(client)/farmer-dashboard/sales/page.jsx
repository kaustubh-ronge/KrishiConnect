      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card className="bg-green-50 border-green-200">
            <CardContent className="p-6 flex items-center gap-4">
                <div className="p-3 bg-green-100 rounded-full text-green-600"><IndianRupee className="h-8 w-8"/></div>
                <div>
        ...
        <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6 flex items-center gap-4">
                <div className="p-3 bg-blue-100 rounded-full text-blue-600"><Package className="h-8 w-8"/></div>
                <div>
                    ...
                    {sales.length > 0 ? (
                        sales.map((sale) => (
                            <tr key={sale.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4">
                                    <Badge className="bg-green-100 text-green-800 border-green-200 shadow-none">Paid</Badge>
                                </td>
                            </tr>
                        ))
                    ) : (
                        <tr>
                            <td colSpan="6" className="px-6 py-12 text-center text-gray-500">
                                No sales yet. Listed products will appear here when sold.
                            </td>
                        </tr>
                    )}
                </tbody>
