...
import { Textarea } from "@/components/ui/textarea";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
import { Package, Truck, Eye, Calendar, User, Phone, MapPin, Clock, Edit3, X, CheckCircle2 } from "lucide-react";
                      ...
                      {order.items.map(item => (
                        <div key={item.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          <div className="flex items-center gap-4">
                            {/* Product Image */}
                            <div className="h-16 w-16 bg-white border border-gray-200 rounded-md overflow-hidden flex-shrink-0 relative">
          ...
          {selectedOrder && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {selectedOrder.items.map(item => (
                    <div key={item.id} className="p-3 border rounded-lg flex items-center gap-4">
