        ...
        <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;background:#f8fafc;border-radius:16px;overflow:hidden;border:1px solid #e2e8f0;">
          ...
          <div style="background:#ffffff;padding:36px 40px;">
            ...
            <p style="margin-top:24px;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL}/admin" style="background:#1e40af;color:#ffffff;padding:12px 24px;text-decoration:none;border-radius:8px;font-weight:600;display:inline-block;">Review in Dashboard →</a>
            </p>
          </div>
        </div>
      `,
